...
export const MINIO_PUBLIC_ENDPOINT = process.env.MINIO_PUBLIC_ENDPOINT; // Optional: overrides URL in generated file links (useful on Railway: private connect, public URLs)
