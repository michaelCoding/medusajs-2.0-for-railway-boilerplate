const colors = {
  ...
  backgroundColor: {
    ...
    'fg-primary-negative-hover': 'rgb(var(--fg-primary-negative-hover) / <alpha-value>)',
    'fg-primary-negative-pressed': 'rgb(var(--fg-primary-negative-pressed) / <alpha-value>)',
  ...
  textColor: {
    ...
    'action-primary-hover': 'rgb(var(--content-action-primary-hover) / <alpha-value>)',
    'action-primary-pressed': 'rgb(var(--content-action-primary-pressed) / <alpha-value>)',
  ...
  borderColor: {
    ...
    'action-primary-inverse': 'rgb(var(--border-action-primary-inverse) / <alpha-value>)',
    'action-primary-hover': 'rgb(var(--border-action-primary-hover) / <alpha-value>)',
    'action-primary-pressed': 'rgb(var(--border-action-primary-pressed) / <alpha-value>)',
